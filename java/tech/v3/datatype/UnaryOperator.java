...
public interface UnaryOperator extends ElemwiseDatatype, IFnDef, clojure.lang.Fn
{
  Object unaryObject(Object arg);
  default long unaryLong(long arg) { return Casts.longCast(unaryObject(arg)); }
  default double unaryDouble(double arg) { return Casts.doubleCast(unaryObject(arg)); }
