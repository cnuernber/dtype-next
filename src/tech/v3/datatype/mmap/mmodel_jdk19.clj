(ns tech.v3.datatype.mmap.mmodel-jdk19
  "Mmap based on the MemorySegment jdk19 memory model pathway"
  (:require [tech.v3.datatype.ffi.native-buffer-mmodel-jdk19 :as nbuf-mmodel]
         ...
         channel (FileChannel/open (->path fpath)
                                   (into-array OpenOption
                                               (case mmap-mode
                                                 ...
                                                 :private
                                                 [StandardOpenOption/READ])))
         rscope (MemorySession/openShared)
         mseg (.map channel
                    (case mmap-mode
