  ...
  (case (count keys)
    ...
    8 (let [sfact (FastStruct/createFactory (vec keys))]
        (fn [v1 v2 v3 v4 v5 v6 v7 v8]
          (let [obj-ary (object-array 8)]
            (ArrayHelpers/aset obj-ary 0 v1)
            (ArrayHelpers/aset obj-ary 1 v2)
            (ArrayHelpers/aset obj-ary 2 v3)
            (ArrayHelpers/aset obj-ary 3 v4)
...
(comment
  ...
  (defn profile-list
    ...
    (let [fact-fn
      ...
      (println "imvector")
      (time (dotimes [iter 1000000] (fact-fn imlist/vector)))
      (println "imlist")
